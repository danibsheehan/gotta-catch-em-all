...
describe('PokemonBattleResultComponent', () => {
  ...
  let battle: { playAgain: ReturnType<typeof vi.fn> };
  let battleHistory: { recordMatch: ReturnType<typeof vi.fn> };
  let audio: { playBattleResult: ReturnType<typeof vi.fn> };
  ...
  beforeEach(async () => {
    battle = {
      playAgain: vi.fn().mockName('PokemonBattleService.playAgain'),
    };
    battleHistory = {
      recordMatch: vi.fn().mockName('BattleHistoryService.recordMatch'),
    };
    audio = {
      playBattleResult: vi.fn().mockName('AudioService.playBattleResult'),
    };
  ...
  it('should not start battle when stats are missing', async () => {
  ...
  it('should show resolving state until outcome is ready', async () => {
    component.ngOnChanges({
      pokemonChoice: new SimpleChange(null, pokemonChoiceStub, true),
      pokemonOpponent: new SimpleChange(null, pokemonOpponentStub, true),
    });
  ...
  it('should set win result when choice attack is greater', async () => {
    component.pokemonChoice = pokemonChoiceStub;
    component.pokemonOpponent = pokemonOpponentStub;
  ...
  it('should set lose result when choice attack is not greater', async () => {
  ...
  it('should call battle.playAgain when Play again is clicked', async () => {
    component.ngOnChanges({
      pokemonChoice: new SimpleChange(null, pokemonChoiceStub, true),
      pokemonOpponent: new SimpleChange(null, pokemonOpponentStub, true),
    });
